...
import com.pscher.weather.navigationapi.MainDestinations
import com.pscher.weather.navigationapi.MainNavigationActions
import com.pscher.weather.navigationapi.MainNavigationActionsImpl
...
fun MainNavGraph(
    ...
    navActions: MainNavigationActions = remember(navController) {
        MainNavigationActionsImpl(navController)
    }
) {
